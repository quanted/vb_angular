...
export class LocationService implements OnDestroy {
    ...
    getLocations(): Observable<any> {
        return this.http.get(environment.apiURL + "location/").pipe(
    ...
    addLocation(newLocation): Observable<any> {
        return this.http.post(environment.apiURL + "location/", newLocation).pipe(
            takeUntil(this.ngUnsubscribe),
            catchError((err) => {
                console.log(err);
    ...
    updateLocation(updatedLocation, id): Observable<any> {
        return this.http.put(environment.apiURL + `location/${id}/`, updatedLocation).pipe(
            takeUntil(this.ngUnsubscribe),
            catchError((err) => {
                console.log(err);
    ...
    deleteLocation(id): Observable<any> {
        return this.http.delete(environment.apiURL + `location/${id}/`).pipe(
            takeUntil(this.ngUnsubscribe),
            catchError((err) => {
                console.log(err);
